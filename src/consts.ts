...
// ---------------------------------------------------------------------
// ---------------------------------------------------------------------
// 【2026-07-18 忍者AdMax 停止】
//   理由：7/1〜7/17で表示378・クリック6・確定収益0円（予想1円／RPM約2.6円）。
//   収益がほぼゼロである一方、記事内に広告が挟まる信頼性コストが発生するため停止。
//   タグを空文字にすると、DisplayAd / rehypeInArticleAd 側のガードにより
//   一切描画されない（空枠・ラベルも出ない）。コードは残しているので、
//   再開する場合は下のコメント内の src を戻すだけでよい。
//
//   再開用（停止前の値）：
//     記事下   : https://adm.shinobi.jp/s/0937cd67c11152e687f7d6a496f41824
//     記事中   : https://adm.shinobi.jp/s/efc7d07663ae3f526ba4974dd64e79bd
// ---------------------------------------------------------------------
// 記事下（関連記事の下・/app CTA より下）※停止中
export const ADMAX_TAG_SRC = '';
// 記事中（最初の見出しの直後に1枠・rehypeで自動挿入）※停止中
